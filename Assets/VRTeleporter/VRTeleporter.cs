...
public class VRTeleporter : MonoBehaviour
{
    ...
    public GameObject body; // target transferred by teleport
    ...
    public void Teleport()
    {
        if (groundDetected)
        {
            ...
            body.transform.position = groundPos + lastNormal * 0.1f;
            body.GetComponent<CharacterController>().enabled = true;
        }
        else
        {
